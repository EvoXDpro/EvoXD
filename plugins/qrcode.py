...
from . import check_filename, get_string, EvoXD_bot, EvoXD_cmd


@EvoXD_cmd(pattern="qrcode( (.*)|$)")
async def cd(e):
    ...
    elif EvoXD_bot.me.photo and not EvoXD_bot.me.photo.has_video:
        cimg = await e.client.get_profile_photos(EvoXD_bot.uid, limit=1)[0]
