...
def load_addons(plugin_name):
    ...
    if base_name.startswith("__"):
        return
    from pyEvoXD import fns

    from .. import HNDLR, LOGS, asst, udB, EvoXD_bot
    from .._misc import _supporter as config
    from .._misc._assistant import asst_cmd, callback, in_pattern
    from .._misc._decorators import EvoXD_cmd
    ...
    for path in configPaths:
        modules[path] = config
    modules["pyEvoXD.functions"] = fns
    mod.LOG_CHANNEL = udB.get_key("LOG_CHANNEL")
    mod.udB = udB
    mod.asst = asst
    mod.tgbot = asst
    mod.EvoXD_bot = EvoXD_bot
    mod.ub = EvoXD_bot
    mod.bot = EvoXD_bot
    mod.EvoXD = EvoXD_bot
    mod.borg = EvoXD_bot
    mod.telebot = EvoXD_bot
    mod.jarvis = EvoXD_bot
    mod.friday = EvoXD_bot
    mod.eod = eod
    mod.edit_delete = eod
    mod.LOGS = LOGS
    ...
    mod.EvoXD_cmd = EvoXD_cmd
    mod.on_cmd = EvoXD_cmd
